 ...
 * @author devil
 */
@WebServlet(name = "necesito_ayuda", urlPatterns = {"/necesito_ayuda"})
public class necesito_ayuda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet necesito_ayuda</title>");
