 ...
 * @author Alumno
 */
@WebServlet(name = "registra_contacc", urlPatterns = {"/registra_contacc"})
public class registra_contacc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet registra_contacc</title>");
            out.println("<script>\n" +
"            function presiona1(){\n" +
"                setTimeout(function (){\n" +
                ...
                if(!(user==null)){
                    ...
                    try{
                        ...
                        if(validacarac==0){
                            ...
                            contacc=new contacto_confianza(0, nombre, apellido_p, apellido_m);
                            if(!(request.getParameter("telefono").equals("") && request.getParameter("correo").equals(""))){
                                ...
                                int realizado=controla_contacc.altacontacto_confianza(contacc, correo, lista_contac);
                                if(realizado==1){
                                    out.println("<script>alert('Resgistro realizado');</script>");
